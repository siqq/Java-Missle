...
public class WarGui extends JFrame {
	public WarGui() {
		...
		springLayout.putConstraint(SpringLayout.NORTH, controlPanel, 233, SpringLayout.NORTH, getContentPane());
		...
		springLayout.putConstraint(SpringLayout.NORTH, lblEnemyMissileInterception, 10, SpringLayout.NORTH, getContentPane());
		springLayout.putConstraint(SpringLayout.SOUTH, lblEnemyMissileInterception, -618, SpringLayout.SOUTH, getContentPane());
		springLayout.putConstraint(SpringLayout.NORTH, progressPanel, 6, SpringLayout.SOUTH, lblEnemyMissileInterception);
